...
export default function AdminCampaigns({ loaderData }: Route.ComponentProps) {
		...
		<div className="container mx-auto px-4 py-8">
			<div className="flex flex-col space-y-4">
				...
				<p className="text-muted-foreground">
					Manage and monitor student welfare campaigns and fundraising
					initiatives.
				</p>
						...
						<div className="p-5">
							...
							<div className="flex items-center justify-between">
								<Button
									variant="brand"
									className="w-full"
									href={`/admin/campaigns/${campaign.id}/show`}
								>
									Edit Campaign
								</Button>
								<Button
			...
			{campaigns.length === 0 && (
				<div className="mt-8 flex flex-col items-center justify-center rounded-lg border border-border bg-card p-8 text-center">
					...
					<p className="mt-2 text-sm text-muted-foreground">
						Create a new campaign using the button above to start fundraising
						for student welfare initiatives.
					</p>
				</div>
			)}
		</div>
